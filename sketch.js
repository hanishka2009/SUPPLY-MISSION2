...
function setup() {//re t mode()
	...
	packgeSprite = Bodies.rectangle(x,y,width,height)
	World.add(world,packageSprite)

	helicopterSprite=createSprite(width/2, 200, 10,10);
	helicopterSprite.addImage(helicopterIMG)
	helicopterSprite.scale=0.6
	helicopterSprite = Bodies.rectangle(x,y,width,height)
	World.add(world,helicopterSprite)

	groundSprite=createSprite(width/2, height-35, width,10);
	groundSprite.shapeColor=color(255)

line1=createSprite(width/2.28,height-80,20,80);
line1.shapeColor=color("red")
line1=Bodies.rectangle(x,y,width,height)
World.add(world,line1)
line2=createSprite(width/1.7,height-80,20,80);
line2.shapeColor=color("red")
line2=Bodies.rectangle(x,y,width,height)
World.add(world,line2)
line3=createSprite(width/1.93,height-50,110,20);
line3.shapeColor=color("red")
line3=Bodies.rectangle(x,y,width,height)
